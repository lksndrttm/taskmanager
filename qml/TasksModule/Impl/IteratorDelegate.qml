...
Rectangle {
    ...
    property string isRoundBeginTime: "false"
    ...
    Text {
        ...
        text:  "[" + (compliteCount - level*upLevelScore) + "/" + upLevelScore + "]"
        color: "#555555"
        font.pointSize: Style.iterMaxSeriesTextHeight
    ...
    Rectangle {
        id: _decreaseButton
        width: Style.iterCompliteButtonHeight + 10
        height: Style.iterCompliteButtonHeight
        anchors.right: _increaseButton.left
...
//        to: root.levelInfo[0]
        value: (compliteCount - level*upLevelScore)/ upLevelScore
    }
